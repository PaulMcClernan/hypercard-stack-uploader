...
-- Messages are sent to buttons, fields, cards, backgrounds, and stacks. The targets can catch them in script handlers.
-- If they are not caught, they are sent down the message path to their containing cards and backgrounds, and then the stack.
...
--------------------------------- end OpenXTalk additions --------------------------------- end OpenXTalk additions ---------------------------------
